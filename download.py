  ...
  <head>
    ...
    <!-- JSON-LD markup generated by Google Structured Data Markup Helper. -->
		<script type="application/ld+json">
		{
		  ...
		  "name" : "MOSAIC",
		  "image" : "https://pages.nist.gov/mosaic/assets/img/icon.png",
		  "url" : "https://pages.nist.gov/mosaic",
		  "author" : {
		    "@type" : "Person",
		    "name" : "Arvind Balijepalli"
		  },
		  ...
		  "applicationCategory" : "Single-molecule analysis",
		  "downloadUrl" : "https://pages.nist.gov/mosaic/download.html",
		  "operatingSystem" : "Windows; Mac OS",
		  "screenshot" : "https://pages.nist.gov/mosaic/assets/img/GUI-01.png",
		  "softwareVersion" : "2.0",
  		  "offers": {
		    "@type": "Offer",
...
if __name__ == '__main__':
  ...
  vers=[
    ...
    ("Version 2.0b1", "2.0b1", ".f98ae80", True),
