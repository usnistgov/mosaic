...
*Generate publication time-series plots using the
...
Plots are generated using the ``mosaicscripts.plots.timeseries`` module.
See the `timeseries module <../mosaicscripts/plots/timeseries.py>`__ for
additional details.

Basic usage to plot 1 second of ionic current vs. time is shown below.
The ``plotopts`` argument is used to style the curve in the plot.
...
.. image:: TimeseriesPlots_files/TimeseriesPlots_3_0.png
...
that the conversion to voltage to current is performed with the ``Rfb``
and ``Cfb`` parameters, passed to the plotting function as a dictionary.
...
.. image:: TimeseriesPlots_files/TimeseriesPlots_5_0.png
...
.. image:: TimeseriesPlots_files/TimeseriesPlots_7_0.png
